...
class Lab5_3 : ComponentActivity() {
    ...
    Column(
        ...
        if (selectedCategories.isNotEmpty()) {
            ...
            AssistChip(
                ...
                label = {
                    Text(
                        text = "Clear selections", style = TextStyle(
...
fun SuggestionChips(
    ...
    Row(
        ...
        suggesttions.forEach { suggestion ->
            ...
            SuggestionChip(
                onClick = { onCategorySelected(suggestion) },
